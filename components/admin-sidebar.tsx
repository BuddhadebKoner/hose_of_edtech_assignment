...
export default function AdminSidebar() {
   ...
   return (
      <aside
         className={`flex h-screen flex-col border-r border-border/40 bg-sidebar transition-all duration-300 ${
      ...
      >
         ...
         <div className="border-t border-border/40 p-3">
            ...
            <button
               ...
               className={`mt-2 flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm text-red-500 transition-colors hover:bg-red-50 dark:hover:bg-red-950/30 ${
                  collapsed ? "justify-center" : ""
               }`}
